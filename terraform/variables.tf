...
variable "terraform_aws_modules_vpc" {
  type = string
  default = "3.14.0"
}
...
variable "project" {
  type = string
  default = "eks-alb-2-node"
}
# variable "dna_terraform_state" {}


variable "rds_enabled" {
  type = bool
  description = "Shall we create RDS?"
  default = true
}
...
variable "elasticache_enabled" {
  type = bool
  description = "Shall we create ElastiCache?"
  default = true
}

# variable "vpc_ids" {
#   description = "The ID's of all the VPC's."
...
variable "local_users" {
  description = "list of usernames in current account"
  type        = list(string)
  default     = []
}

variable "external_users" {
  description = "list of external AWS accounts user ARNs"
  type        = list(string)
  default     = []
}
